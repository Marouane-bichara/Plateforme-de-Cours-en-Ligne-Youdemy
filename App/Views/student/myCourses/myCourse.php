...
<body class="bg-gray-100 text-gray-800">
  <header class="bg-white shadow">
    <div class="container mx-auto px-6 py-4 flex justify-between items-center">
      ...
      <nav class="hidden md:flex space-x-6">
        ...
        <a href="./myCourses.php" class="text-gray-700 hover:text-blue-600">My Courses</a>
    ...
    <nav id="mobile-menu" class="hidden bg-white shadow-md">
      <ul class="space-y-4 p-4">
        ...
        <li><a href="./myCourses.php" class="block text-gray-700 hover:text-blue-600">My Courses</a></li>
  ...
  <main class="container mx-auto p-6">
    <div class="text-center mb-10">
      <h1 class="text-4xl font-semibold">Your Courses</h1>
      <p class="text-gray-600 mt-2">Watch or cancel your courses below</p>
    </div>
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
  <?php foreach ($courses as $course): ?>
    <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 flex flex-col h-full">
    ...
    <div class="p-6 flex-grow">
      ...
      <div class="border-t p-4 mt-auto flex justify-between">
        <form method="POST" action="./cancel.php">
          ...
          <button type="submit" name="cancel" class="px-4 py-2 bg-red-500 hover:bg-red-600 text-white rounded-md">
            Cancel
          </button>
        </form>
        <form method="GET" action="./watch/watch.php">
          <input type="hidden" name="course_id" value="<?= htmlspecialchars($course['course_id']) ?>">
